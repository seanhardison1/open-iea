...
author: "Sean Hardison, Kimberly Bastille, Sarah Gaichas, Sean Lucey,<br> Ellen Spooner, Ben Best, Jennifer Brown, Scott Cross, Kelly Kearney" 
output:
...
```{r, echo = F}
knitr::include_graphics(here::here("images/open-science1.png"))
```
...
Framework for assessing marine ecosystem health from local to global scales scales<sup>1</sup> 

```{r, echo = F, message = F, fig.align = "center", out.width = "35%"}
knitr::include_graphics(here::here("images/ohi_score_example.png"))
```
...
# 
# ggsave(map, file = here::here("images/epu_map.png"), bg = "transparent")
knitr::include_graphics(here::here("images/epu_map.png"))
```
]
...
knitr::include_graphics(here::here("images/zoomability.png"))
```
...
.pull-right[
```{r, echo = F, out.width = "100%", fig.align = "center"}
knitr::include_graphics(here::here("images/tech-doc-gif.gif"))
```
]
...
knitr::include_graphics(here::here("images/soe_compare.png"))
```
...
```{r, echo = F}
knitr::include_graphics(here::here("images/tech_doc_CI.png"))
```
...
* Workshops allowing for scientists to discuss science outside IEA and 
...
.pull-right[
```{r, echo = F}
knitr::include_graphics(here::here("images/credits.png"))
```
]
